...
public class GetFieldsForProduct {
    ...
    private final String freeFormStaging;
    ...
    public GetFieldsForProduct(Credential cdt, String amount) {
        ...
        this.amount = amount;
        this.freeFormStaging = cdt.getFormFreeStaging();
    ...
    private SOAPMessage callSoapWebService(String soapEndpointUrl, String soapAction) {
        ...
        try {
            ...
            System.out.println("Response getFieldForProduct Message:");
            soapResponse.writeTo(System.out);
            System.out.println();

        } catch (Exception e) {
            System.err.println("\nError occurred while sending getFieldForProduct Request to Server!\nMake sure you have the correct endpoint URL and SOAPAction!\n");
            e.printStackTrace();
        }
    ...
    private SOAPMessage createSOAPRequest(String soapAction) throws Exception {
        ...
        System.out.println("Request getFieldForProduct Message:");
    ...
    private void createSoapEnvelope(SOAPMessage soapMessage) throws SOAPException {
        ...
        SOAPElement soapBodyElem = soapBody.addChildElement("getFieldsForProductRequest", myNamespace, myNamespaceURI);
        ...
        SOAPElement soapBodyElem9 = soapBodyElem.addChildElement("receiveCountry", myNamespace);
        soapBodyElem9.addTextNode("BGD");
        SOAPElement soapBodyElem10 = soapBodyElem.addChildElement("deliveryOption", myNamespace);
        soapBodyElem10.addTextNode("WILL_CALL");
        SOAPElement soapBodyElem11 = soapBodyElem.addChildElement("thirdPartyType", myNamespace);
        soapBodyElem11.addTextNode("NONE");
        SOAPElement soapBodyElem12 = soapBodyElem.addChildElement("receiveCurrency", myNamespace);
        soapBodyElem12.addTextNode("BDT");
        SOAPElement soapBodyElem13 = soapBodyElem.addChildElement("amount", myNamespace);
        soapBodyElem13.addTextNode(this.amount);
        SOAPElement soapBodyElem14 = soapBodyElem.addChildElement("productType", myNamespace);
        soapBodyElem14.addTextNode(this.productType);
        SOAPElement soapBodyElem15 = soapBodyElem.addChildElement("consumerId", myNamespace);
        soapBodyElem15.addTextNode(this.consumerId);
        SOAPElement soapBodyElem16 = soapBodyElem.addChildElement("formFreeStaging", myNamespace);
        soapBodyElem16.addTextNode(this.freeFormStaging);
